...
<<<<<<< HEAD
  var _config$android$jsEng, _config$android;

  return (_config$android$jsEng = (_config$android = config.android) === null || _config$android === void 0 ? void 0 : _config$android.jsEngine) !== null && _config$android$jsEng !== void 0 ? _config$android$jsEng : DEFAULT_JS_ENGINE;
}

function setJsEngine(config, gradleProperties) {
  var _config$android$jsEng2, _config$android2;
=======
...
<<<<<<< HEAD
    value: (_config$android$jsEng2 = (_config$android2 = config.android) === null || _config$android2 === void 0 ? void 0 : _config$android2.jsEngine) !== null && _config$android$jsEng2 !== void 0 ? _config$android$jsEng2 : DEFAULT_JS_ENGINE
=======
