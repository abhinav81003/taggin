...
=======
var injectedNamesToPlugins$jscomp$inline_226 = {
>>>>>>> e75a71e2c6ac3e5d484a463ebda2ebf8c6ccb707
...
=======
  isOrderingDirty$jscomp$inline_227 = !1,
  pluginName$jscomp$inline_228;
for (pluginName$jscomp$inline_228 in injectedNamesToPlugins$jscomp$inline_226)
  if (
    injectedNamesToPlugins$jscomp$inline_226.hasOwnProperty(
      pluginName$jscomp$inline_228
    )
  ) {
    var pluginModule$jscomp$inline_229 =
      injectedNamesToPlugins$jscomp$inline_226[pluginName$jscomp$inline_228];
    if (
      !namesToPlugins.hasOwnProperty(pluginName$jscomp$inline_228) ||
      namesToPlugins[pluginName$jscomp$inline_228] !==
        pluginModule$jscomp$inline_229
    ) {
      if (namesToPlugins[pluginName$jscomp$inline_228])
        throw Error(
          "EventPluginRegistry: Cannot inject two different event plugins using the same name, `" +
            pluginName$jscomp$inline_228 +
            "`."
      ...
      isOrderingDirty$jscomp$inline_227 = !0;
    }
  }
isOrderingDirty$jscomp$inline_227 && recomputePluginOrdering();
>>>>>>> e75a71e2c6ac3e5d484a463ebda2ebf8c6ccb707
      ...
      if (!objectIs(version, maybeNewVersion)) {
        ...
        for (
          ...
          var index$13 = 31 - clz32(lanes),
            lane = 1 << index$13;
          entanglements[index$13] |= maybeNewVersion;
          lanes &= ~lane;
        }
      }
    },
...
=======
      case 4:
        ...
        for (prevDispatcher = -1; 0 < lanes; ) {
          ...
          lanes$jscomp$0 = 1 << index$6;
          index$6 = exitStatus[index$6];
          index$6 > prevDispatcher && (prevDispatcher = index$6);
...
function commitRootImpl(root, renderPriorityLevel) {
  ...
  for (
    ...
    var index$12 = 31 - clz32(noLongerPendingLanes),
      lane = 1 << index$12;
    remainingLanes$jscomp$0[index$12] = 0;
...
=======
  ...
  for (var i = 0; i < unmountEffects.length; i += 2) {
    var effect$97 = unmountEffects[i],
      fiber = unmountEffects[i + 1],
      destroy = effect$97.destroy;
    effect$97.destroy = void 0;
  ...
  for (i = 0; i < unmountEffects.length; i += 2) {
    effect$97 = unmountEffects[i];
    fiber = unmountEffects[i + 1];
    try {
      var create$101 = effect$97.create;
      effect$97.destroy = create$101();
    } catch (error$102) {
      if (null === fiber) throw Error("Should be working on an effect.");
      captureCommitPhaseError(fiber, error$102);
    }
  }
  for (unmountEffects = root.current.firstEffect; null !== unmountEffects; )
    (create$101 = unmountEffects.nextEffect),
      (unmountEffects.nextEffect = null),
      unmountEffects.flags & 8 &&
        ((unmountEffects.sibling = null), (unmountEffects.stateNode = null)),
      (unmountEffects = create$101);
  tracing.__interactionsRef.current = prevInteractions;
...
var internals$jscomp$inline_1148 = {
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1149 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1149.isDisabled &&
    hook$jscomp$inline_1149.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1149.inject(
        internals$jscomp$inline_1148
      )),
        (injectedHook = hook$jscomp$inline_1149);
    } catch (err) {}
}
>>>>>>> e75a71e2c6ac3e5d484a463ebda2ebf8c6ccb707
