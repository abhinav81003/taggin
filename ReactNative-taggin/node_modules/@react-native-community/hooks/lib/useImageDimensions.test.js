...
describe('useImageDimensions', function () {
    describe('external images', function () {
        ...
        it('should invoke getSize with with passed uri', function () {
            react_hooks_1.renderHook(function () { return useImageDimensions_1.useImageDimensions(mockSource); });
        ...
        it('should return error when cannot get image size', function () {
            ...
            var result = react_hooks_1.renderHook(function () { return useImageDimensions_1.useImageDimensions(mockSource); }).result;
        ...
        it('should update image size when source change', function () {
            ...
            var _a = react_hooks_1.renderHook(function (props) { return useImageDimensions_1.useImageDimensions(props.source); }, { initialProps: { source: mockSource } }), result = _a.result, rerender = _a.rerender;
            expect(result.current).toEqual({ loading: true });
            react_hooks_1.act(function () { return emitOnSuccess(1, 2); });
            expect(result.current).toEqual({
                loading: false,
            ...
            expect(result.current).toEqual({ loading: true });
            react_hooks_1.act(function () { return emitOnSuccess(3, 4); });
            expect(result.current).toEqual({
                loading: false,
    ...
    describe('bundled up images', function () {
        ...
        it('should invoke resolveAssetSource with passed image', function () {
            react_hooks_1.renderHook(function () { return useImageDimensions_1.useImageDimensions(mockImage); });
        ...
        it('should return image dimensions', function () {
            ...
            var result = react_hooks_1.renderHook(function () { return useImageDimensions_1.useImageDimensions(mockImage); }).result;
            expect(result.current).toEqual({
                loading: false,
                dimensions: {
                    width: width,
    ...
    it('should return an error when pass non image', function () {
        ...
        var result = react_hooks_1.renderHook(function () {
            return useImageDimensions_1.useImageDimensions(
