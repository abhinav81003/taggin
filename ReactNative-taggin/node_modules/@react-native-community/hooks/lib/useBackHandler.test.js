...
describe('useBackHandler', function () {
    ...
    it('should add back press listener on mount', function () {
        var handler = jest.fn();
        react_hooks_1.renderHook(function (props) { return useBackHandler_1.useBackHandler(props.handler); }, {
    ...
    it('should resubscribe when passed handler will change', function () {
        ...
        var rerender = react_hooks_1.renderHook(function (props) { return useBackHandler_1.useBackHandler(props.handler); }, {
            initialProps: { handler: handler },
        }).rerender;
        expect(addEventListenerMock).toBeCalledWith('hardwareBackPress', handler);
    ...
    it('should remove back press listener on unmount', function () {
        var handler = jest.fn();
        var unmount = react_hooks_1.renderHook(function (props) { return useBackHandler_1.useBackHandler(props.handler); }, {
            initialProps: { handler: handler },
        }).unmount;
